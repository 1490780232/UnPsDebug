...
def clust_rank(mat, image_in=None, initial_rank=None, distance='cosine'):
    s = mat.shape[0]
...
def FINCH(data, image_in = None, initial_rank=None, req_clust=None, distance='cosine', verbose=True):
    ...
    min_sim = None
    adj, orig_dist = clust_rank(data,image_in, initial_rank, distance)
    initial_rank = None
